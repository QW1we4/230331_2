...
const App = () => {
  ...
  return (
    <div className="bg-red-100 min-h-screen flex flex-col justify-center items-center">
      ...
      <div className="mb-4">
        <input
          className="border-2 border-gray-800 focus:outline-none focus:border-red-400 rounded-lg px-4 py-2 text-xl"
          type="text"
          value={num1}
          onChange={onChangeNum1}
        />
        <input
          className="border-2 border-gray-800 focus:outline-none focus:border-blue-400 rounded-lg px-4 py-2 text-xl ml-4"
          type="text"
          value={num2}
